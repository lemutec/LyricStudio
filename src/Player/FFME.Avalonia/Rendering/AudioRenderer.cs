...
internal sealed class AudioRenderer : IDisposable, IMediaRenderer, IWaveProvider, ILoggingSource
{
    ...
    public void OnClose()
    {
        ...
        if (Application.Current is { } app)
        {
            ...
            {
                Dispatcher.UIThread.InvokeAsync(new Action(() => { desktop.Exit -= OnApplicationExit; }));
            }
        }
    ...
    #endregion IWaveProvider Support
    ...
    /// <param name="eventArgs">exit event args</param>
    ...
    #endregion DSP (All called inside the Read method)
}

...
public sealed class ClosedCaptionPacket : IComparable<ClosedCaptionPacket>, IEquatable<ClosedCaptionPacket>
{
    ...
    internal ClosedCaptionPacket(TimeSpan timestamp, byte header, byte d0, byte d1)
    {
        ...
        try
        {
            ...
            #endregion XDS Packet Detection
            ...
            #endregion Color Command Detection (Table 3)
            ...
            #endregion Charset Select Packet Detection (Table 4)
            ...
            #endregion MidRow Code Detection (Table 69)
            ...
            #endregion Misc Command Detection (Table 70)
            ...
            #endregion Preamble Command Detection (Table 71)
            ...
            #endregion Text Parsing (Table 5, 6, 7, 8, 9, 10, and 68 for ASCII Chars)

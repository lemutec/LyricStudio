...
internal static class ConfigurationKeys
{
    ...
    public static readonly SettingKey<bool> IsShowAudioVisualization = new(nameof(IsShowAudioVisualization), defaultValue: true);
    public static readonly SettingKey<bool> IsShowHighting = new(nameof(IsShowHighting), defaultValue: false);

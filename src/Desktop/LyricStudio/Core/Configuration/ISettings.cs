...
public interface ISettings
{
    ...
    [Description("Try using generic SetValue() instead, unless you don't know the type of value.")]
...
public static class SettingsExtensions
{
    ...
    [Description("Try using generic GetValueOrDefault() instead, unless you don't know the type of value.")]

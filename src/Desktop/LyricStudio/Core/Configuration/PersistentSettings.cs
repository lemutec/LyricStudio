...
public abstract class PersistentSettings : ISettings
{
    ...
    private EventHandler<SettingChangedEventArgs>? settingChanged;
    private EventHandler<SettingChangingEventArgs>? settingChanging;
    private readonly Dictionary<SettingKey, object> values = [];

...
namespace LyricStudio.Core.Translators.MicrosoftEdge;

public class EdgeTranslationQueryResult : ITranslator
{
    ...
    private static string? s_currentJwt;

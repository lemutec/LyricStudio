    ...
    where TConverter : new()
{
    ...
    public static readonly AvaloniaProperty BaseOnFalseValueProperty = PropertyHelper.Create<bool, ValueToBoolConverterBase<T, TConverter>>(nameof(BaseOnFalseValueProperty));
}
